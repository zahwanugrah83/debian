...
echo "" | lolcat
echo "" | lolcat
echo "            --[ SELAMAT DATANG  DI VPS Bayu Aldiansyah ]--"| boxes -d dog | lolcat
echo "            ====================================================="| lolcat
echo "            #           WhatsApp     : 085322449800             #"| lolcat
echo "            #           Telegram     : Bayu Aldiansyah                #"| lolcat
echo "            #           Facebook     : fb.com/Bayu Aldiansyah   #"| lolcat
echo "            #           Pin-BBM      : D1923                    #"| lolcat
echo "            #---------------------------------------------------#"| lolcat
echo "            #     Silahkan ketik [menu] ENTER untuk pilihan     #"| lolcat
echo "            #---------------------------------------------------#"| lolcat
echo "            #    Copyright: © Bayu Aldiansyah™ Premium 2017     #"| lolcat
echo "            ====================================================="| lolcat
date +"                            %A, %d-%m-%Y" | lolcat
date +"                                 %H:%M:%S %Z" | lolcat
echo ""
